"""
Django settings for clonvideo project.
...
SECRET_KEY = '*ld9i*5dl)+!%()&4sngnj1=l=jl)n4sv_@yxotc4ua&c5_iy+'
...
WSGI_APPLICATION = 'clonvideo.wsgi.application'
